...
jsfetch_set_read_timeout(a0: number): Promise<void>;
jsfetch_set_fetch_timeout(a0: number): Promise<void>;
jsfetch_set_initial_retry_delay(a0: number): Promise<void>;
...
jsfetch_set_read_timeout_sync(a0: number): void;
jsfetch_set_fetch_timeout_sync(a0: number): void;
jsfetch_set_initial_retry_delay_sync(a0: number): void;
